...
// наш TVector из лабы номер 3 и немного модифицируем

// 1. приписываем строку template<typename T> перед классом
// 2. меняем строку using value_type = int; на using value_type = T;
// 3. Profit!
